...
const char * FFmpegDecoder::get_h264_nalu(const char* data, int len, unsigned char *sps, unsigned int *p_sps_len, unsigned char *pps,unsigned int *p_pps_len, bool *sync)
{
    bool issync = false;
